...
def test_empty_matching_vertical():
    assert mwpm_pairs([], "vertical") == []


def test_empty_matching_horizontal():
    assert mwpm_pairs([], "horizontal") == []


def test_no_span_empty_vertical():
    assert correction_spans_code([], "vertical") is False


def test_no_span_empty_horizontal():
    assert correction_spans_code([], "horizontal") is False


def test_single_defect_matches_boundary():
    pairs = mwpm_pairs([0], "vertical")
